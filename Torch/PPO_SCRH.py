...
# Memory for that both actor and critic will access
class PPOMemory:
    ...
    # We have integers that correspond to indices in our memory
    # We use this and randomize this on our batch to get random batches
    def generate_batches(self):
        ...
        return np.array(self.states),\
                ...
                np.array(self.dones),\
                batches
    # just appending to store memory
...
class ActorNetwork(nn.Module):
    def __init__(self,n_actions,input_dims,alpha,
        ...
        self.checkpoint_file = os.path.join(chkpt_dir,"torch_actor")
    ...
    # Getting the distribution for future policy calculations
